...
public class UnityActivity extends UnityPlayerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        u3d_layout = (RelativeLayout) findViewById(R.id.u3d_layout);
        ...
        findViewById(R.id.btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mRgba = new Mat();
                mGray = new Mat();
                final Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.liuyifei);
                checkFace(bmp);
            }
        });
        ...
        findViewById(R.id.btn2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mRgba = new Mat();
                mGray = new Mat();
                final Bitmap bmp=BitmapFactory.decodeResource(getResources(), R.drawable.add);
                checkFace(bmp);
            }
        });
    }
    ...
    private void checkFace(Bitmap imgtemp) {
//        Bitmap imgtemp = BitmapFactory.decodeResource(getResources(), R.mipmap.facessss).copy(Bitmap.Config.ARGB_8888, true);
...
//                System.arraycopy(tempPoints, 0, keyPoints, 0, keyPoints.length);
                ...
                for (int i = 0; i < tempPoints.length; i++) {
                    Log.e("keyPoints:", tempPoints[i]+"");
                    str = str +(int) tempPoints[i].x +" " +(int) tempPoints[i].y + " ";
                }
                Log.e("str:", str);
                UnityPlayer.UnitySendMessage("Manager", "MatchingFace", str);
